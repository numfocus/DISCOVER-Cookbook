...
- Eligibility Requirements
  - Applicants should be 
    ...
    - and be unable to attend without some financial assistance. (language adapted from 
    <!--[The Linux Foundation](https://www.linuxfoundation.org/event/api-strategy-practice-conference-2017/diversity-scholarship/))
